...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            val courseTitle = findViewById<TextView>(R.id.tv_course_name)
            val courseTime = findViewById<TextView>(R.id.tv_time)
            val courseLecturer = findViewById<TextView>(R.id.tv_lecturer)
